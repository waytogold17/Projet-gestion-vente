<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="site_php.css">
...
<nav class="navbar navbar-default navbar-fixed-top navbarperso">
    <div class="container">
...
<polygon class="st0" points="60.1,260.3 167.4,341 180.4,380.3 "/>
		...
		<h1 class="brand brand-name navbar-left"><div class="navbar-left"><a href="site php.php" style="color:black">SWYPE</a></h1>
        </div>
        <div class="collapse navbar-collapse navbar-right" id="myNavbar">
            <ul class="nav navbar-nav">
                <li><a href="categorieForm.php">Categorie</a></li>
   				<li><a href="clientForm.php">Client</a></li>
   				<li><a href="fournisseurForm.php">Fournisseur</a></li>
    			<li><a href="factureForm.php">Facture</a></li>
    			<li><a href="produitForm.php">Produit</a></li>
    			<li><a href="detaillerForm.php">Détail</a></li>
 ...
 <div style="text-align: center;"> 
            <h3>Bienvenue sur le site de notre société</h3>
      </div>
</body>
</html>